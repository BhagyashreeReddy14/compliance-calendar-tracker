...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedCompliance() {
        ...
        List<Compliance> records = List.of(
                ...
                // COMPLETED — past due dates
                build("Q3 GST Filing",                "Quarterly GST return filing for Q3 — completed",           "COMPLETED",   today.minusDays(10)),
                ...
                build("TDS Return Q4",                "TDS return filing for Q4 — overdue",                       "OVERDUE",     today.minusDays(3)),
                build("Shop Act License Renewal",     "Shop and establishment act license renewal — overdue",     "OVERDUE",     today.minusDays(7)),
                build("Professional Tax Filing",      "Professional tax filing for employees — overdue",          "OVERDUE",     today.minusDays(12)),
                build("Import Export Code Renewal",   "IEC renewal with DGFT — overdue",                         "OVERDUE",     today.minusDays(18)),
                build("Trademark Renewal",            "Trademark registration renewal — overdue",                 "OVERDUE",     today.minusDays(22)),

                // CLOSED
                build("Q2 Payroll Compliance",        "Payroll compliance check for Q2 — closed",                 "CLOSED",      today.minusDays(45)),
