...
public class AiServiceClient {
    ...
    public String describe(String text) {
        try {
            ...
            return response != null ? (String) response.get("description") : "No description generated";
        } catch (Exception e) {
    ...
    public String recommend(String text) {
        try {
            ...
            return response != null ? (String) response.get("recommendation") : "No recommendation generated";
        } catch (Exception e) {
